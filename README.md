...
- GitHub Actions validate the application and Firebase Functions; focused Firestore profile, journal-submission, and Journal visibility rule tests run in the application job.
